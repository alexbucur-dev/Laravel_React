              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/1.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/2.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/3.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/4.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/5.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-success"></span>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'img/avatars/6.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-danger"></span>
                      </div>
                    </td>
                    <td>
